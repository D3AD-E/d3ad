import { Experience } from "./ExperienceTimeline.types";
...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    location: "Warsaw, Poland",
    highlights: [
      "Optimized page rendering by 60%",
      "Implemented React Native payment system",
      "Designed database schemas and CI/CD pipelines",
